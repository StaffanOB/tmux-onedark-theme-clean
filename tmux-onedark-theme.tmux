...
set "status-right" "#[fg=$onedark_white,bg=$onedark_black,nounderscore,noitalics,nobold] ${date_format} ${time_format}"
...
set "window-status-current-format" "#[fg=$onedark_white,bg=$onedark_visual_grey,nobold,nounderscore,noitalics] #I #[fg=$onedark_highlight,bg=$onedark_visual_grey,bold]#W #[fg=$onedark_visual_grey,bg=$onedark_black,nobold,nounderscore,noitalics]:"
